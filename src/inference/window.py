...
# TODO: refactor with a better name
class InferenceOrchestrator(BaseInferenceOrchestrator):
    """
    ...
    def __init__(
        ...
        super().__init__(model, window_builder, reconstructor, device, verbose)
    ...
    def run(
        ...
        window_split = self.builder.build_subset(
            ...
            step=self.seq_len,  # Stride = Length -> No Overlap
